						...
						<div className="row offset-margin">
							<div className="col-sm-6 col-lg-3">
								<div className="icon-item">
									<div className="icon-item__img"><img className="img--layout" src="../../../assets/img/icon_1.png" alt="img"/><span className="js-counter">20</span></div>
							...
							<div className="col-sm-6 col-lg-3">
								<div className="icon-item">
									<div className="icon-item__img"><img className="img--layout" src="../../../assets/img/icon_2.png" alt="img"/><span className="js-counter">32</span></div>
									<div className="icon-item__text">
										<p>Country</p>
									</div>
								</div>
							...
							<div className="col-sm-6 col-lg-3">
								<div className="icon-item">
									<div className="icon-item__img"><img className="img--layout" src="../../../assets/img/icon_3.png" alt="img"/><span className="js-counter">200 </span><span>+</span></div>
									<div className="icon-item__text">
							...
							<div className="col-sm-6 col-lg-3">
								<div className="icon-item">
									<div className="icon-item__img"><img className="img--layout" src="../../../assets/img/icon_4.png" alt="img"/><span className="js-counter">65 </span><span>b</span></div>
									<div className="icon-item__text">
						...
						<div className="row margin-bottom">
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_1.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_1.jpg" alt="teammate"/></div>
									</div>
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_2.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_2.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_3.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_3.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_4.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_4.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_5.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_5.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_6.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_6.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_7.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_7.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								...
								<div className="team-item team-item--rounded">
									...
									<div className="team-item__img-holder"><img className="img--layout" src="../../../assets/img/team_8.png" alt="layout"/>
										<div className="team-item__img"><img className="img--bg" src="../../../assets/img/team_8.jpg" alt="teammate"/></div>
									</div>
									<div className="team-item__description">
								...
								<div className="slider-holder">
									<div className="donors-slider donors-slider--style-1">
										<div className="donors-slider__item">
											<div className="donors-slider__img"><img src="../../../assets/img/donor_1.png" alt="donor"/></div>
										</div>
										<div className="donors-slider__item">
											<div className="donors-slider__img"><img src="../../../assets/img/donor_2.png" alt="donor"/></div>
										</div>
										<div className="donors-slider__item">
											<div className="donors-slider__img"><img src="../../../assets/img/donor_3.png" alt="donor"/></div>
										</div>
										<div className="donors-slider__item">
											<div className="donors-slider__img"><img src="../../../assets/img/donor_4.png" alt="donor"/></div>
										</div>
									</div>
								</div>
								{/* <!-- donors slider end--> */}
