									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_4.jpg" alt="img"/></div>
											</div>
							...
							<div class="col-xl-10 offset-xl-1">
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_5.jpg" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details.html">Help for Language. Voluanteer</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
							...
							<div class="col-xl-10 offset-xl-1">
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_6.jpg" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details.html">Bike Racing Charity Event 2019</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
							...
							<div class="col-xl-10 offset-xl-1">
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_7.jpg" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details.html">Trinity Trash Bash</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
							...
							<div class="col-xl-10 offset-xl-1">
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_8.jpg" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details.html">Snowdon by Night</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
							...
							<div class="col-xl-10 offset-xl-1">
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											<div class="col-lg-5 col-xl-4">
												<div class="upcoming-item__img"><img class="img--bg" src="../../../assets/img/event_9.jpg" alt="img"/></div>
											</div>
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details.html">The Big Sleep Out</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
